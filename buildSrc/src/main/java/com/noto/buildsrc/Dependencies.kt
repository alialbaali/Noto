...
object Libraries {
    ...
    object Remote {
        ...
        const val LOGGER = "io.ktor:ktor-client-logging-jvm:${Versions.KTOR}"
    ...
    object Testing {
        ...
        const val KTOR_TEST = "io.ktor:ktor-client-mock-jvm:${Versions.KTOR}"
...
object App {
    const val APP_ID = "com.noto.fullstack"
...
object Plugins {
    ...
    const val DEPENDENCIES_VERSIONS = "com.github.ben-manes:gradle-versions-plugin:${Versions.DEPENDENCIES_VERSIONS}"
}