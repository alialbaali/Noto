...
class LabelListRVAdapter(private val labelItemListener: LabelItemListener) : ListAdapter<Label, LabelListRVAdapter.LabelItemViewHolder>(LabelItemDiffCallback()) {
    ...
    class LabelItemViewHolder(private val binding: ItemLabelBinding, labelItemListener: LabelItemListener) :
        ...
        private val rippleDrawable by lazy {
            RippleDrawable(ColorStateList.valueOf(resources.getColor(label.labelColor.getValue())), drawable, drawable)
        }
        ...
        fun bind(label: Label) {
            ...
            binding.ivLabelNotoColor.imageTintList = ResourcesCompat.getColorStateList(resources, label.labelColor.getValue(), null)
            binding.root.background = rippleDrawable
            binding.root.backgroundTintList = ResourcesCompat.getColorStateList(resources, label.labelColor.getValue(), null)
        }
    }
