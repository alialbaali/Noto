...
class MainFragment : BaseDialogFragment(isCollapsable = true) {
    ...
    private fun MainFragmentBinding.setupState() {
        ...
        tvFoldersCount.typeface = context?.tryLoadingFontResource(R.font.nunito_semibold_italic)
        ...
        state.fold(
            onSuccess = { allFolders ->
                ...
                rv.withModels {
                    ...
                    tvFoldersCount.text =
                        context?.quantityStringResource(R.plurals.folders_count, foldersCount, foldersCount)?.lowercase()
