...
typealias RecentNotesModel = Map<LocalDate, List<Pair<Folder, NoteItemModel>>>
...
class RecentNotesViewModel(
    ...
    private val mutableNotes = MutableStateFlow<UiState<RecentNotesModel>>(UiState.Loading)
