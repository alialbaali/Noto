...
class LabelDialog(context: Context, private val viewModel: LabelListViewModel, private val label: Label) :
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (label.labelId == 0L) {
            ...
            binding.til.setStartIconTintList(context.resources.getColorStateList(label.notoColor.resId, null))
        }
        ...
        binding.rgNotoColors.setOnCheckedChangeListener { group, checkedId ->
            ...
            binding.til.setStartIconTintList(context.getColorStateList(notoColor.resId))
        }
    }
