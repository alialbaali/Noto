...
import com.noto.databinding.ItemBlockBinding
import timber.log.Timber

class NotoRVAdapter(private val blockListener: BlockListener) : ListAdapter<String, NotoRVAdapter.StringViewHolder>(StringItemDiffCallback()) {
